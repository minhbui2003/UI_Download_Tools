...
async function ensureSchema() {
  if (!pgState.schemaReady || pgState.schemaVersion !== SCHEMA_VERSION) {
    pgState.schemaReady = pool.query(`
      ...
      ALTER TABLE tools ADD COLUMN IF NOT EXISTS mac_link TEXT;
  ...
  try {
    ...
    pgState.schemaVersion = SCHEMA_VERSION;
